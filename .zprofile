...
export PATH=$PATH:$HOME/bin:/Users/alexd/bin:/sbin:/bin:/usr/sbin:/usr/bin:/usr/games:/usr/local/sbin:/usr/local/bin:/opt/local/bin:/opt/local/sbin::/opt/local/lib/mysql55/bin/:$HOME/.rvm/bin
